        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                ...
                <div class="row p-2" id="createBook">
                    <div class="card-body">
                        {!! Form::open(['route' => 'books.store', 'method' => 'POST', 'class' => 'needs-validation',
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('book_name') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('book_name', null, ['id' => 'book_name', 'class' => 'form-control',
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('book_cost') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::number('book_cost', null, ['id' => 'book_cost', 'class' => 'form-control',
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('book_date') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::date('book_date', null, ['id' => 'book_date', 'class' => 'form-control',
