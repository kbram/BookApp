<x-app-layout>
    <x-slot name="header">
        <div class="row">
            ...
            <div class="col">
                <a href="books/create" type="button" class="btn btn-outline-light shadow rounded pull-right" id="newBook">New Book</a>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12" >
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class=" overflow-hidden shadow-lg p-3 mb-5  " style="background-color:#cedcee;border-radius: 15px;border-color:black; ">
