<x-app-layout>
    ...
    <div class="py-12 mt-3">
        ...
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
            ...
            The features of digital wallets bring value both for ordinary users and businesses. Here is the list of the most significant ones. 
            Having all the necessary cards and other important data in an app, there is no need for keeping dozens of cards and papers inside of a wallet, purse or backpack as well as for wasting time searching for them. Everything you need is close at hand, easily managed, and easy to use.Such an app allows the queues in the stores to move faster since the payment is done in less than a minute. In case of online shopping, the digital wallet saves time on entering the credit card details and identification because everything is already confirmed within the app. Better expenses tracking. The information about all the transactions you do is stored inside the app which allows you to analyze it after each week or month in order to control the expenses better. If it is hard for you to stay in a budget, you can set up the limits for particular categories of expenses that will prevent you from
            </div>
        </div>
        ...
        <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
                ...
                <i class="fa fa-money fa-2x"   aria-hidden="true"></i>
                    <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="/dashboard">Total Payment Details</a></div>
                </div>
            ...
            <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="/dashboard">Book vise Report</a></div>
                </div>
