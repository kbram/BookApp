    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg"
                style=" border-width:2px;  border-style:outset;">
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">ID</th>
                            ...
                            @foreach ($payments as $payment)
                                ...
                                <td>
                                    <a href="{{ URL::to('payments/' . $payment->id . '/edit') }}" type="button"
                                        class="btn btn-warning btn-sm shadow rounded  "><i class="fa fa-pencil-square-o"
                                            aria-hidden="true"></i></a>
                                    <!-- <button type="button" class="btn btn-primary btn-sm shadow  "><i class="fa fa-eye" aria-hidden="true"></i></button> -->
                                    <a type="button" class="btn btn-danger btn-sm shadow rounded  btn-payment "
                                        id="{{ $payment->id }}"><i class="fa fa-trash" aria-hidden="true"></i></a>
