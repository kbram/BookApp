        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4">
                ...
                <div class="row p-2" id="createBook">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => ['payments.update', $payment->id], 'method' => 'PUT', 'class' =>
                        'needs-validation']) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('amount') ? ' has-error ' : '' }}">
                            {!! Form::label('amount', 'Recived Amount', ['class' => 'col-md-3 control-label']) !!}
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::number('amount', $payment->amount, ['id' => 'amount', 'class' =>
                                    'form-control', 'placeholder' => 'Recived Amount']) !!}
                        ...
                        <div id="payPercentage"
                            ...
                            {!! Form::label('payment_percentage', 'Payment Percentage', ['class' => 'col-md-3
                            control-label']) !!}
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::number('payment_percentage', $payment->percentage, ['id' =>
                                    'payment_percentage', 'class' => 'form-control', 'max' => '100', 'min' => '0']) !!}
